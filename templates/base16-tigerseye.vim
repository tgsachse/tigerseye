" Base16 tigerseye (https://github.com/chriskempson/base16)
" Scheme: Tiger Sachse (github.com/tgsachse)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-tigerseye.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-tigerseye"
